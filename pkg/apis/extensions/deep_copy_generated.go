...
func deepCopy_extensions_ConfigData(in ConfigData, out *ConfigData, c *conversion.Cloner) error {
	if err := deepCopy_unversioned_TypeMeta(in.TypeMeta, &out.TypeMeta, c); err != nil {
		return err
	}
	if err := deepCopy_api_ObjectMeta(in.ObjectMeta, &out.ObjectMeta, c); err != nil {
...
func deepCopy_extensions_ConfigDataList(in ConfigDataList, out *ConfigDataList, c *conversion.Cloner) error {
	if err := deepCopy_unversioned_TypeMeta(in.TypeMeta, &out.TypeMeta, c); err != nil {
		return err
	}
	if err := deepCopy_unversioned_ListMeta(in.ListMeta, &out.ListMeta, c); err != nil {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := deepCopy_extensions_ConfigData(in.Items[i], &out.Items[i], c); err != nil {
				return err
			}
		}
	} else {
...
func init() {
	err := api.Scheme.AddGeneratedDeepCopyFuncs(
		...
		deepCopy_extensions_ConfigData,
		deepCopy_extensions_ConfigDataList,
