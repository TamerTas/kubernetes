...
func ValidateConfigData(cfg *experimental.ConfigData) errs.ValidationErrorList {
	allErrs := errs.ValidationErrorList{}
...
func ValidateConfigDataUpdate(oldCfg, newCfg *experimental.ConfigData) errs.ValidationErrorList {
	allErrs := errs.ValidationErrorList{}
