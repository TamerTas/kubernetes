...
import (
	...
	realapi "k8s.io/kubernetes/pkg/apis/experimental"
)
...
func validNewConfigData() *api.ConfigData {
	return &api.ConfigData{
		ObjectMeta: realapi.ObjectMeta{
			Name:      "foo",
			Namespace: "default",
		},
...
func TestCreate(t *testing.T) {
	...
	validConfigData.ObjectMeta = realapi.ObjectMeta{
		GenerateName: "foo-",
	}
	...
	test.TestCreate(
		...
		&api.ConfigData,
		&api.ConfigData{
			ObjectMeta: realapi.ObjectMeta{Name: "name"},
			Data: map[string]string{
				"key": "value",
			},
		},
